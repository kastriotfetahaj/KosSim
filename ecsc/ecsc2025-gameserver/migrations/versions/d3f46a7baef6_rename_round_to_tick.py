...
def upgrade():
    ...
    op.create_index(
        op.f("ix_checker_results_tick"), "checker_results", ["tick"], unique=False
    )

    op.alter_column(
        "services", "flags_per_round", nullable=False, new_column_name="flags_per_tick"
    )
    ...
    op.alter_column(
        ...
        "round_submitted",
        nullable=False,
        new_column_name="tick_submitted",
    )
    op.alter_column(
        "submitted_flags", "round_issued", nullable=False, new_column_name="tick_issued"
    )
    op.drop_index("ix_submitted_flags_round_submitted", table_name="submitted_flags")
    op.create_index(
        op.f("ix_submitted_flags_tick_submitted"),
        "submitted_flags",
        ["tick_submitted"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_team_rankings_tick"), "team_rankings", ["tick"], unique=False
    )
...
def downgrade():
    ...
    op.create_index(
        "ix_checker_results_round", "checker_results", ["round"], unique=False
    )

    op.alter_column(
        "services", "flags_per_tick", nullable=False, new_column_name="flags_per_round"
    )
    ...
    op.alter_column(
        ...
        "tick_submitted",
        nullable=False,
        new_column_name="round_submitted",
    )
    op.alter_column(
        "submitted_flags", "tick_issued", nullable=False, new_column_name="round_issued"
    )
    op.drop_index(
        op.f("ix_submitted_flags_tick_submitted"), table_name="submitted_flags"
    )
    op.create_index(
        "ix_submitted_flags_round_submitted",
        "submitted_flags",
        ["round_submitted"],
        unique=False,
    )
