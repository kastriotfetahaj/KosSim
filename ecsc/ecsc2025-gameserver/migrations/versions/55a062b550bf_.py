...
def upgrade():
    ...
    op.add_column(
        "team_traffic_stats",
        sa.Column("forward_self_bytes", sa.BigInteger(), nullable=False),
    )
    op.add_column(
        "team_traffic_stats",
        sa.Column("forward_self_packets", sa.BigInteger(), nullable=False),
    )
    op.add_column(
        "team_traffic_stats",
        sa.Column("forward_self_syn_acks", sa.BigInteger(), nullable=False),
    )
    op.add_column(
        "team_traffic_stats",
        sa.Column("forward_self_syns", sa.BigInteger(), nullable=False),
    )
