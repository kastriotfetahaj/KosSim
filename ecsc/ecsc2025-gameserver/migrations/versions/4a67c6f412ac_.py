...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "level", sa.SmallInteger(), server_default=sa.text("0"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "ts", sa.TIMESTAMP(), server_default=sa.text("now()"), nullable=False
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "submitted_by",
    ...
    op.create_table(
        ...
        sa.Column(
            "message", sa.String(), server_default=sa.text("NULL"), nullable=True
        ),
        sa.Column("time", sa.Float(), server_default=sa.text("NULL"), nullable=True),
        sa.Column(
            "integrity", sa.Boolean(), server_default=sa.text("FALSE"), nullable=False
        ),
        sa.Column(
            "stored", sa.Boolean(), server_default=sa.text("FALSE"), nullable=False
        ),
        sa.Column(
            "retrieved", sa.Boolean(), server_default=sa.text("FALSE"), nullable=False
        ),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "round", "team_id", "service_id", name="checker_results_unique_1"
        ),
    )
    op.create_table(
        "team_points",
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "round", "team_id", "service_id", name="team_points_unique_1"
        ),
    )
    op.create_table(
        "team_rankings",
