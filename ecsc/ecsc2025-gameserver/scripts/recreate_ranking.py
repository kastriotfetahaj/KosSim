...
def recreate_ranking(
    tick_start: int, tick_end: Optional[int], refresh_scoreboard: bool
) -> int:
    sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
...
if __name__ == "__main__":
    ...
    t = time.time()
    print(
        "Recreating ranking from tick {} to tick {}...".format(
            tick_start, tick_end or "<current>"
        )
    )
