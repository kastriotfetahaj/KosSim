...
export interface ServiceResult {
    p: number; // total service points
    o: number; // off_points
    d: number; // def_points
    s: number; // sla multiplier
    dp: number; // delta total service points
    do: number; // delta off_points
    dd: number; // delta def_points
    ds: number; // delta sla multiplier
    st: number; // stolen
    cap: number; // captured
...
export interface Rank {
    ...
    rank: number;
    points: number;
    dp: number; // delta total points
    o: number; // off_points
    d: number; // def_points
    s: number; // average sla multiplier
    do: number;
    dd: number;
    ds: number;
