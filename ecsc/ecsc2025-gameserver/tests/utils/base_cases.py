...
config_basis = {
    ...
    "scoring": {"flags_rounds_valid": 10, "nop_team_id": 1},
    "network": {
        "game": "127.0.0.0/16",
        "__ip_syntax": [
            "number",
        ...
        with db_session_2() as session:
            ...
            session.add(
                Service(
                    id=2,
                    name="Service2",
                    checker_script="checker_runner.demo_checker:FlagNotFoundService",
                    checker_timeout=1,
                    num_payloads=0,
                    flags_per_tick=1,
                )
            ...
            session.add(
                Service(
                    id=3,
                    name="Service3",
                    checker_script="checker_runner.demo_checker:TimeoutService",
                    checker_timeout=1,
                    num_payloads=2,
                    flags_per_tick=2,
                )
